# 在线考试系统 DRM 绕过与批量提取工具

网络攻防课程实训作业。针对 XJTLU 在线考试系统的 PDF.js 阅读器，分析其多层前端 DRM 防护机制，设计 Canvas 层提取方案完成绕过，实现批量自动化提取。
...
└── exam_pages/            # 产出目录
    ├── EEE112_2022-23_F/  # 课程代码_学年_类型 (F=期末 T=补考)
    ├── EEE112_2022-23_T/
    └── ...
```
